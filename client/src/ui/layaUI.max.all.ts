...
module ui.test {
    export class LiangSelectUI extends Dialog {
        ...
        public static  uiView:any ={"type":"Dialog","props":{"width":1920,"height":1080},"child":[{"type":"Button","props":{"y":659,"x":1075,"var":"okBtn","skin":"base/btn_normal.png","scaleY":1.5,"scaleX":1.5,"labelSize":40,"labelPadding":"0,0,6,0","labelColors":"#FFFFFF,#FFFFFF,#FFFFFF","label":"确定选择"}},{"type":"Label","props":{"y":675,"x":543,"width":427,"text":"请选择需要杠的牌","overflow":"hidden","height":72,"fontSize":50,"color":"#ffffff","bold":true}},{"type":"Sprite","props":{"y":839,"x":99,"width":1324,"var":"shouPai3","scaleY":1.3,"scaleX":1.3,"height":172}}]};
        constructor(){ super()}
        createChildren():void {
