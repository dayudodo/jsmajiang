...
module ui.test {
    export class WinnerUI extends View {
		...
		public skin_shoupai3:Laya.Image;
		public fa3:Laya.Sprite;
		public hupai_names3:Laya.Label;
		...
		public hupai_names0:Laya.Label;
		public score0:Laya.Label;
