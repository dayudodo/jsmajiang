...
module mj.net {
    ...
    export class Manager {
        ...
        private showPeng(groupShou: ShoupaiConstuctor, player: Player, x_one_pai_width: number, y_one_pai_height: number) {
        ...
        private showMingGang(groupShou: ShoupaiConstuctor, player: Player, x_one_pai_width: number, y_one_pai_height: number) {
        ...
        private showSelfPeng(groupShou: ShoupaiConstuctor, player: Player, x_one_pai_width: number, y_one_pai_height: number) {
            if (groupShou.selfPeng.length > 0) {
                //显示自碰牌
                groupShou.selfPeng.forEach(selfPengPai => {
                    let cloneSelfPengSprite = LayaUtils.clone(this.gameTable["selfPeng" + player.ui_index]) as Sprite;
                ...
                for (var i = 0; i < groupShou.selfPengCount; i++) {
                    let cloneselfPengHideSprite = LayaUtils.clone(this.gameTable["selfPengHide" + player.ui_index]) as Sprite;
        ...
        private showAnGang(groupShou: ShoupaiConstuctor, player: Player, x_one_pai_width: number, y_one_pai_height: number) {
