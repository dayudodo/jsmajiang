...
exports.TablePaiManager = void 0;
var config = require("./config");
var _ = require("lodash");
var PaiConvertor_1 = require("./PaiConvertor");
/**直接将字符串转换成数类麻将数组 */
function pais(strs) {
...
var TablePaiManager = /** @class */ (function () {
    ...
    TablePaiManager.player23_liangTest = function () {
        ...
        [player1, player2, player3].forEach(function (paiItems) {
            paiItems.forEach(function (pai, index) {
                allpais.remove(pai);
            });
        });
    ...
    TablePaiManager.player1_3gang = function () {
        ...
        [player1, player2, player3, fa_pais].forEach(function (paiItems) {
            paiItems.forEach(function (pai) {
                allpais.remove(pai);
            });
        });
        newPais = newPais.concat(allpais);
        newPais.push.apply(newPais, tails);
        return newPais;
    };
    ...
    /**七对放炮 */
    TablePaiManager.player2_qidiu_ting = function () {
        var allpais = TablePaiManager.fapai_random();
    ...
    /**player2碰fa打t7后能亮 */
    TablePaiManager.peng_da_liang = function () {
        var allpais = TablePaiManager.fapai_random();
    ...
    /**庄家打牌就有人能碰 */
    TablePaiManager.zhuang_fangPeng = function () {
        var allpais = TablePaiManager.fapai_random();
        var player1 = pais("b1 t1 t1 t3 t7 t8 t9 zh zh fa di di di");
    ...
    /**庄家打b1后player2能杠 */
    TablePaiManager.zhuang_fangGang = function () {
        var allpais = TablePaiManager.fapai_random();
        var player1 = pais("b1 t1 t1 t3 t7 t8 t9 zh zh fa di di di");
        var player2 = pais("b1 b1 b1 b2 b3 b4 t1 t2 t4 t5 zh fa fa");
        var player3 = pais("b5 b6 b7 b8 b9 t4 t4 t6 t7 t8 t9 zh zh");
    ...
    TablePaiManager.player2_fang_GangShangGang = function () {
        var allpais = TablePaiManager.fapai_random();
    ...
    /**庄家打牌就能亮 */
    TablePaiManager.zhuang_dapai_liang = function () {
        var allpais = TablePaiManager.fapai_random();
    ...
    /**庄家打t6放player2屁胡炮 */
    TablePaiManager.zhuang_dapai_fangpao = function () {
        var allpais = TablePaiManager.fapai_random();
        var player1 = pais("b1 b2 b3 b4 b5 b6 t3 t4 t6 t7 t8 di di");
    ...
    /**庄家打t6一炮双响 */
    TablePaiManager.zhuang_dapai_shuang = function () {
        var allpais = TablePaiManager.fapai_random();
    ...
    /**庄家杠上花 */
    TablePaiManager.zhuang_GangShangHua = function () {
        var allpais = TablePaiManager.fapai_random();
        ...
        newPais = newPais.concat(player3);
        newPais = newPais.concat(fa_pais);
        [player1, player2, player3, fa_pais, tails].forEach(function (paiItems) {
            paiItems.forEach(function (pai, index) {
                allpais.remove(pai);
            });
        });
        newPais = newPais.concat(allpais);
        newPais.push.apply(newPais, tails); //先删除掉，然后在数组最后添加这个t5, 以便杠上开花！
        return newPais;
    };
    /**庄家双杠上花 */
    TablePaiManager.zhuang_ShuangGangShangHua = function () {
        var allpais = TablePaiManager.fapai_random();
    ...
    /**庄家放t2杠,扛上扛di,胡扛上花t5 */
    TablePaiManager.zhuang_FangGangHuGang = function () {
        var allpais = TablePaiManager.fapai_random();
        ...
        newPais = newPais.concat(allpais);
        newPais.push.apply(newPais, tails); //先删除掉，然后在数组最后添加tails, 以便杠上开花！
        return newPais;
    };
    /**庄家能扛。但player2扛牌后能能胡，player3能亮 */
    TablePaiManager.zhuangGang_Player2ZhiMo_player3Liang = function () {
        var allpais = TablePaiManager.fapai_random();
