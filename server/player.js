...
var Player = /** @class */ (function () {
    ...
    Object.defineProperty(Player.prototype, "lose_names", {
    ...
    Object.defineProperty(Player.prototype, "gang_lose_codes", {
        /**出杠钱的数字代码 */
        get: function () {
            return this.gang_lose_data.map(function (d) { return d.type; });
        },
        enumerable: true,
        configurable: true
    });
    ...
    Player.prototype.canGangPais = function () {
        var _this = this;
        var output = [];
        output = output.concat(this.group_shou_pai.peng.filter(function (pai) { return _this.group_shou_pai.shouPai.includes(pai); }));
        output = output.concat(this.group_shou_pai.selfPeng.filter(function (pai) { return _this.group_shou_pai.shouPai.includes(pai); }));
        output = output.concat(this.PaiArr4A());
        return output;
    };
    /**返回group手牌中出现4次的牌！ */
    Player.prototype.PaiArr4A = function () {
        var result = _.countBy(this.group_shou_pai.shouPai);
        var output = [];
    ...
    Player.prototype.canGang = function (pai) {
    ...
    /**  从玩家手牌中删除pai并计算胡牌*/
    Player.prototype.da_pai = function (pai_name) {
        ...
        var shouPaiChanged = pai_name != this.mo_pai;
        if (shouPaiChanged) {
            this.group_shou_pai.shouPai.sort();
            this.calculateHu();
        }
