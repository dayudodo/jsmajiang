...
ava_1.default("普通屁胡", function (t) {
    ...
    let na_pai = "t6";
    t.is(MajiangAlgo_1.MajiangAlgo._HuisPihu(MajiangAlgo_1.checkValidAndReturnArr(str), na_pai), true);
});
...
ava_1.default("少张屁胡 false", function (t) {
    ...
    let na_pai = "b1";
    t.is(MajiangAlgo_1.MajiangAlgo._HuisPihu(MajiangAlgo_1.checkValidAndReturnArr(str), na_pai), false);
});
