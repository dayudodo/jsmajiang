...
describe('Base is', function() {
	it('should isAA', function() {
		expect(isAA('b1 b1')).toBe(true)
	});
	it('should isAA', function() {
		expect(isAA('b1b1')).toBe(true)
	});
	it('should isAAA', function() {
		expect(isAAA('b1 b1 b1')).toBe(true)
		expect(isAAA_reg('b1 b1 b1')).toBe(true)
	});
	it('should isAAA false', function() {
		expect(isAAA('b1 b1   b2')).toBe(false)
	});
	...
	describe('ABC group', function() {
		...
		it('should isABC throw null error', function() {
			expect(isABC).toThrowError('str is null or undefined')
